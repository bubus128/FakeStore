...
public class FakeStoreApiClient(HttpClient httpClient, ILogger<FakeStoreApiClient> logger) : IFakeStoreApiClient
{
	...
	public async Task<List<string>> GetCategoriesAsync()
	{
		try
		{
			var response = await httpClient.GetAsync("https://fakestoreapi.com/products/categories");
	...
	public async Task<List<Product>> GetProductsByCategoryAsync(string category)
	{
		try
		{
			var response = await httpClient.GetAsync($"https://fakestoreapi.com/products/category/{category}");
			if (!response.IsSuccessStatusCode)
			{
	...
	public async Task<Cart> GetCartAsyncByUserId(int userId)
	{
		try
		{
			var response = await httpClient.GetAsync($"https://fakestoreapi.com/carts/user/{userId}");
			if (!response.IsSuccessStatusCode)
			{
	...
	public async Task<Cart> GetCartAsyncById(int cartId)
	{
		try
		{
			var response = await httpClient.GetAsync($"https://fakestoreapi.com/carts/{cartId}");
			if (!response.IsSuccessStatusCode)
			{
	...
	public async Task AddToCartAsync(int cartId, int productId)
	{
		try
		{
			...
			var response = await httpClient.PostAsync("https://fakestoreapi.com/carts", content);
